...
class UserAchievementsControllerTest < ActionController::TestCase
  ...
  test "should create user_achievement" do
    assert_difference('UserAchievement.count') do
      post :create, user_achievement: { achievement_id: @user_achievement.achievement_id, level: @user_achievement.level, user_id: @user_achievement.user_id }
    end
  ...
  test "should update user_achievement" do
    put :update, id: @user_achievement, user_achievement: { achievement_id: @user_achievement.achievement_id, level: @user_achievement.level, user_id: @user_achievement.user_id }
    assert_redirected_to user_achievement_path(assigns(:user_achievement))
  end
