...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { id: @achievement.id, image: @achievement.image, name: @achievement.name, slug: @achievement.slug }
    end
  ...
  test "should update achievement" do
    put :update, id: @achievement, achievement: { id: @achievement.id, image: @achievement.image, name: @achievement.name, slug: @achievement.slug }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
